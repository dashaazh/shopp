...
const NotFound = () => {
  ...
  const FillBg = Ctx.DarkModeStatus ? '#fcbc73' : '#191654';
      ...
      <Grid container>
        <Grid item xs={12}>
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
            <svg style={{ display: 'block', width: '100%', margin: '34px 0' }}
            ...
            >
              ...
              <g fill="none" fill-rule="evenodd">
                ...
                <g transform="translate(-448 -157) translate(448 157)">
                  ...
                  <use fill="#262626" xlinkHref="#prefix__a" />
                  <path
                    fill="#262626"
                    fill-rule="nonzero"
            ...
            <Typography sx={{ color: `${FillBg}`, width: '100%', textAlign: 'center' }} variant="h4">opps Page Not Found</Typography>
            <ButtonWrapper>
